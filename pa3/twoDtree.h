...
public:
   ...
   * You may want a recursive helper function for this one.
   ...
   //pair<long,int> v_split(stats s, pair<int,int> ul, pair<int,int> lr);
   //pair<long,int> h_split(stats s, pair<int,int> ul, pair<int,int> lr);
...
public:
   ...
   */
   ...
   void pruneHelper(double pct, int tol, Node * node);
   int getLeafCount(Node * node);
   double getPercent(Node * node, RGBAPixel a, int leaves,int tol);
   void renderTree(PNG & im, Node* croot);
